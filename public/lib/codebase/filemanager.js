    ...
    ***************************************************************************** */
    ...
    var MenuBodyView = (function (_super) {
        ...
        MenuBodyView.prototype.FilterOptions = function (files) {
            ...
            var viewable = vtypes.indexOf(file.type) != -1 || vtypes.indexOf(file.$ext) != -1;
    ...
    var AddNewMenuView = (function (_super) {
        ...
        AddNewMenuView.prototype.config = function () {
            ...
            return {
                ...
                body: {
                    ...
                    on: {
                        onMenuItemClick: function (id) { return _this.StartAction(id); },
                    },
                },
            };
        };
        ...
        AddNewMenuView.prototype.StartAction = function (id) {
            var _this = this;
    ...
    var FoldersView = (function (_super) {
        ...
        FoldersView.prototype.Subscribe = function () {
            ...
            this.Tree.attachEvent("onAfterSelect", function () {
                ...
                _this.TreeState = _this.Tree.getState();
            });
            ...
            this.app
                ...
                _this.on(collection.data, "onStoreUpdated", function (id) {
                    if (!id && _this.Tree.count()) {
                        _this.Tree.setState(_this.TreeState);
                    }
                });
            });
        };
    ...
    var SideTreeView = (function (_super) {
        ...
        SideTreeView.prototype.config = function () {
            ...
            return {
                ...
                state: function (state) {
                    ...
                    state.top = _this.Parent.top + toolbarHeight;
                    state.height = _this.Parent.height - toolbarHeight;
                },
                body: FoldersView,
            };
        };
        SideTreeView.prototype.init = function () {
            var _this = this;
        ...
        SideTreeView.prototype.Show = function (updatePos) {
    ...
    var DoublePanelView = (function (_super) {
        ...
        DoublePanelView.prototype._TrackChanges = function (state, next) {
            ...
            this.on(state.$changes, "source", function (v) {
                if (state.isActive)
                    _this.State.source = v;
            });
    ...
    var TopBarView = (function (_super) {
        ...
        TopBarView.prototype.init = function () {
            ...
            this.on(common.$changes, "preview", function (v) {
                _this.$$("previewMode").setValue(v * 1);
            });
    ...
    var TopView = (function (_super) {
        ...
        TopView.prototype.init = function () {
            var _this = this;
            this.getRoot().sizeTrigger(this.app, function (mode) { return _this.SetCompactMode(mode); }, !!this.Compact);
            var state = this.getParam("state");
            this.State = state;
            if (this.Compact) {
            ...
            this.on(state.$changes, "preview", function (v) { return _this.TogglePreview(v); });
            this.app
                .getService("progress")
        ...
        TopView.prototype.TogglePreview = function (value) {
            if (!this.Compact) {
    ...
    var Backend = (function () {
        ...
        Backend.prototype.icon = function (obj, size) {
            ...
            return this.url("icons/" + skin + "/" + (size || "small") + "/" + obj.type + "/" + obj.$ext + ".svg");
        };
    ...
    var UploadHandler = (function () {
        ...
        UploadHandler.prototype.createUploader = function (app, directory) {
            var uploader = webix.ui({
                ...
                on: {
                    ...
                    onUploadComplete: function () {
                        ...
                        if (directory) {
                            var path = this.config.tempUrlData.id;
                            var local = app.getService("local");
                            local.refresh(path);
                            local.folders(true);
                        }
                    },
            ...
            if (!directory)
                uploader.attachEvent("onFileUpload", function (file, res) {
                    app.getService("local").addFile(file.urlData.id, res);
                });
            uploader.$updateProgress = function (_, percent) {
        ...
        UploadHandler.prototype.openDialog = function (type, id) {
            var uploader = type == "upload" ? this.uploader : this.dirUploader;
            uploader.config.tempUrlData = { id: id };
            uploader.fileDialog();
        };
